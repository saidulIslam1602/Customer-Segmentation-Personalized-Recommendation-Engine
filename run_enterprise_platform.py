...
async def run_enterprise_analysis(data_dir='data/processed', results_dir='reports', config_path='config/enterprise_config.json'):
    ...
    if results:
        ...
        print(f"Performance Score: {results.get('performance_metrics', {}).get('overall_score', 'N/A')}/100")
  ...
  python run_enterprise_platform.py --mode full --log-level DEBUG
    ...
    try:
        if args.mode in ['analysis', 'full']:
            ...
            results = asyncio.run(run_enterprise_analysis(

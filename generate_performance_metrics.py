...
def generate_high_quality_performance_metrics():
    ...
    segmentation = CustomerSegmentation(
        "data/processed/transactions.csv", "data/processed/customers.csv"
    )
    ...
    executive_summary = {
        ...
        "overall_performance_score": comprehensive_report["executive_summary"][
            "overall_performance_score"
        ],
        "key_performance_indicators": {
            "business_health_score": insights_results["executive_summary"][
                "business_health"
            ]["overall_score"],
            "customer_retention_rate": business_metrics["customer"][
                "repeat_customer_rate"
            ],
            "revenue_growth_rate": business_metrics["revenue"][
        ...
        "business_impact_metrics": {
            ...
            "potential_churn_revenue_saved": churn_metrics["business_impact"][

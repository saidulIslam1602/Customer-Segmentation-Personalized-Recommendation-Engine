...
class APIGateway:
    ...
    def setup_routes(self):
        ...
        @self.app.post("/api/v1/customer-segments", response_model=List[CustomerSegmentResponse])
        async def get_customer_segments(
            ...
            try:
                ...
                segments = []
                customer_ids = request.customer_ids or [f"customer_{i}" for i in range(1, 6)]
        ...
        @self.app.post("/api/v1/churn-prediction", response_model=ChurnPredictionResponse)
